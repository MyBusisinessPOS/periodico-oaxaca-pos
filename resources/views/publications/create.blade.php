        ...
        <div class="col-sm-12 col-md-9 col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form role="form" method="POST" action="{{route('publications.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="publication_type_id" name="publication_type_id" class="form-control @error('publication_type_id') is-invalid @enderror" autocomplete="off">
                                    ...
                                    <option {{old('publication_type_id') == $type->id ?'selected' : ''}} value="{{$type->id}}">{{$type->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="document_type_id" name="document_type_id" class="form-control @error('document_type_id') is-invalid @enderror" autocomplete="off">
                                    ...
                                    <option {{old('document_type_id') == $document->id ?'selected' : ''}} value="{{$document->id}}">{{$document->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('author') is-invalid @enderror" autocomplete="off" id="author" name="author" placeholder="Autor de la Publicación *" value="{{old('author')}}">
                                @error('author')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="publication_category_id" name="publication_category_id" class="form-control @error('publication_category_id') is-invalid @enderror" autocomplete="off">
                                    ...
                                    <option {{old('publication_category_id') == $category->id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('summary')}}" type="text" class="form-control @error('summary') is-invalid @enderror" autocomplete="off" id="summary" name="summary" placeholder="Sumario *">
                            @error('summary')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" autocomplete="off" placeholder="Descripción del archivo *">{{old('description')}}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
